 ...
 * 回復量が大きい。
 */
public class ItemSquareDish extends EdibleEntityItem2 {
	...
	protected boolean spownEntityFoods(World world, EntityPlayer player, ItemStack item, double x, double y, double z) {
		EntitySquarePlate entity = new EntitySquarePlate(world, item, x, y, z);
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer player) {
		if (!world.isRemote && itemStack != null && itemStack.getItemDamage() == 2) {
