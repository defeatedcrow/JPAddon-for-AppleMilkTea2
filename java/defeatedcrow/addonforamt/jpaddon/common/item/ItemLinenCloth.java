...
public class ItemLinenCloth extends Item {

	private static String[] name = { "linen", "cotton" };

	@SideOnly(Side.CLIENT)
	private IIcon iconItemType[];

	public ItemLinenCloth() {
		super();
		this.setMaxDamage(0);
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		...
		for (int i = 0; i < this.name.length; i++) {
			this.iconItemType[i] = par1IconRegister.registerIcon("amtjp:materials/cloth_" + this.name[i]);
		}
	}
}
